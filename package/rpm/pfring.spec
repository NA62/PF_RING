...
Requires: pfring-dkms = 6.5.0, net-tools
...
GIT info: 
rpm:f0091f805d88bf4fbb42c6eff91b6221b68be23b (Thu Jan 19 09:44:15 2017 +0100)
...
cp $HOME/PF_RING/userland/libpcap/pcap-int.h $RPM_BUILD_ROOT/usr/local/include/
...
%changelog
* Wed Dec  5 2012  <deri@centos.ntop.org> - 6.5.0-%{buildrev}
- 
